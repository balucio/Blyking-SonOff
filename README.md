...
Actually this is same code of original *tzapu/SonoffBoilerplate* but use Esp32WifiManager library (https://github.com/madhephaestus/Esp32WifiManager) to handle Wifi configuration.

Next I try to handle sensor *hostname*
